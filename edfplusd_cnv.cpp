...
int main(int argc, char* args[])
{
  ...
  *tal;
  ...
  //  char* inputValue;// = char[100];
  //  strcpy(inputpath, fgets(inputValue, 100, NULL));
  for(int count = 1; count < argc; count++) {
    strcpy(inputpath, args[count]);
    ...
    //  get_directory_from_path(pathName, inputpath, MAX_PATH_LENGTH);
